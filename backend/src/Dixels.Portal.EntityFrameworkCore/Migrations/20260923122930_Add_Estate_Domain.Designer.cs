...
namespace Dixels.Portal.Migrations
{
    ...
    [Migration("20260923122930_Add_Estate_Domain")]
    partial class Add_Estate_Domain
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dixels.Portal.Estate.ActivityLogEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppActivityLogEntries", (string)null);
                });
            ...
            modelBuilder.Entity("Dixels.Portal.Estate.Booking", b =>
                {
                    ...
                    b.HasIndex("OwnerUserId", "Status", "StartUtc", "EndUtc");

                    b.HasIndex("SpaceId", "Status", "StartUtc", "EndUtc");
            ...
            modelBuilder.Entity("Dixels.Portal.Estate.Building", b =>
                {
                    ...
                    b.PrimitiveCollection<List<DateOnly>>("Holidays")
                        .IsRequired()
                        .HasColumnType("date[]");
            ...
            modelBuilder.Entity("Dixels.Portal.Estate.Floor", b =>
                {
                    ...
                    b.Property<int?>("CloseHourOverride")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("MaxBookingHoursOverride")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Dixels.Portal.Estate.Space", b =>
                {
                    ...
                    b.PrimitiveCollection<List<Guid>>("RestrictedTeamIds")
                        .IsRequired()
                        .HasColumnType("uuid[]");
            ...
            modelBuilder.Entity("Dixels.Portal.Estate.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
